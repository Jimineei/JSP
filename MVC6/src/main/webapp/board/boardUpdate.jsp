	...
	<div id="container">
		...
		<div class="location_area member">
			<div class="box_inner">
				...
				<p class="location">BOARD <span class="path">게시판 글수정</span></p>
				...
				<fieldset>
					...
					<ul class="app_list">
						<li class="clear">
							...
							<input type="text" name="name" class="w100p" id="id_lbl" value="${oldDto.name }"/></div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content">
							<input type="text" name="subject" class="w100p" id="pwd_lbl" value="${oldDto.subject }"/></div>
						</li>
						<li class="clear">
							<label for="content_lbl" class="tit_lbl">내용</label>
							<div class="app_content">
							<textarea name="content" id="content_lbl" class="w100p" placeholder="내용" class="tit_lbl">${oldDto.content }</textarea></div>
						</li>
					</ul>
					<!-- p class="btn_line"><a href="javascript:;" class="btn_baseColor">글쓰기</a></p>	 -->
					<p class="btn_line">
					<input type="submit" value="글수정" class="btn_baseColor"></p>
				</fieldset>
			</form>
			<!-- //appForm -->
