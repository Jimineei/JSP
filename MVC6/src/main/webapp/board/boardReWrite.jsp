	...
	<div id="container">
		...
		<div class="location_area member">
			<div class="box_inner">
				...
				<p class="location">BOARD <span class="path">게시판 답글쓰기</span></p>
				...
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content">
							<input type="text" name="subject" class="w100p" id="pwd_lbl" value="[답글]"/></div>
						</li>
						<li class="clear">
					...
					<p class="btn_line">
					<input type="submit" value="답글쓰기" class="btn_baseColor"></p>
				</fieldset>
			</form>
			<!-- //appForm -->
